...
const About = () => {
    ...
    return (
        <section className=" sm:px-8 py-[80px] overflow-hidden" id="about">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 py-6 place-items-center">
                ...
                >
                    <img className="rounded-full" src="https://i.ibb.co/1KWZ23F/Glow-Purple-Modern-Flash-Sale-Instagram-Post-3.png" alt="meme" loading="lazy" />
                </motion.div>
                <motion.div
                    ref={refContent}
    ...
    I am passionate Front-End Developer and Problem Solver, dedicated to creating impactful code for the web.
    <br />
    Experienced in HTML, CSS, JavaScript, React.js, Node.js, Express.js, MongoDB, Tailwind CSS, and Git.
    <br />
    Love coding and eager to expand my knowledge and skills.
</p>
